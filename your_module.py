...
def get_fashion_recommendations(skin_color, body_type, occasion, preferred_style):
    ...
    llm = ChatGoogleGenerativeAI(
        model="gemini-pro", temperature=0.7, top_p=0.85)
...
if __name__ == "__main__":
    ...
    recommendations = get_fashion_recommendations(
        skin_color, body_type, occasion, preferred_style)
    ...
    filter_csv_and_display_images(
        csv_file, primary_keywords, fallback_keywords)
